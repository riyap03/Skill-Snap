          ...
          <div className="card-glow rounded-3xl p-10 text-center relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
                ...
                <Link to="/dashboard" className="px-4 py-2.5 rounded-md border border-gray-200 text-sm hover:bg-surface-elevated">
                  Back to dashboard
                </Link>
              </div>
            </div>
          ...
          <div className="card-glow rounded-3xl p-10 text-center">
            ...
            <div className="mt-6">
              {questions.map((q, i) => {
                ...
                return (
                  <div key={q.id} className="rounded-2xl border border-gray-200 bg-surface/40 p-5 mb-4 text-left">
      ...
      <main className="mx-auto max-w-3xl px-6 py-10">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <button type="button" onClick={() => navigate("/dashboard")} className="p-2 rounded-xl border border-gray-200 hover:bg-surface-elevated">
