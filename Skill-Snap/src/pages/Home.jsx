  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-x-0 -top-40 h-[600px] pointer-events-none" style={{ background: "transparent" }} />
        <div className="relative mx-auto max-w-7xl px-6 pt-20 pb-28 grid lg:grid-cols-[1.05fr_1fr] gap-12 items-center">
          <div className="animate-fade-up">
            <div className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-surface/60 px-3 py-1 text-xs text-muted-foreground mb-6">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link to="/dashboard" className="inline-flex items-center gap-1 px-6 py-3 rounded-md bg-gradient-brand text-primary-foreground shadow-sm hover:opacity-90 text-sm font-medium">
                Get Started <ArrowRight className="h-4 w-4" />
              </Link>
              <a href="#features" className="inline-flex items-center px-6 py-3 rounded-md border border-gray-200 bg-surface/60 hover:bg-surface-elevated text-sm font-medium">
                Explore Features
              </a>
            </div>
            <div className="mt-10 flex items-center gap-6 text-xs text-muted-foreground">
              <div className="flex items-center gap-1.5"><Star className="h-3.5 w-3.5 fill-primary text-primary" /> 4.9 from early users</div>
          ...
          <div className="relative animate-fade-up [animation-delay:120ms]">
            <div className="relative">
              <img src={dashboardHero} alt="SkillSnap dashboard preview" className="relative z-10 w-full shadow-xl" />
              ...
              <FloatingCard className="z-20 right-0 top-1/3 hidden sm:block [animation-delay:1.5s]">
                <div className="font-semibold mb-1 flex items-center gap-1.5"><Sparkles className="h-3.5 w-3.5 text-primary" /> AI suggestion</div>
        ...
        <div className="mt-14 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((f) => (
            <div key={f.title} className="card-glow rounded-2xl p-6 group">
              <div className="h-11 w-11 rounded-xl bg-gradient-brand grid place-items-center shadow-sm group-hover:scale-105 transition-transform">
      ...
      <section id="testimonials" className="relative mx-auto max-w-7xl px-6 py-24">
        <div className="max-w-2xl">
          <div className="text-xs uppercase tracking-[0.2em] text-primary mb-3">Loved by builders</div>
      ...
      <section className="relative mx-auto max-w-5xl px-6 pb-24">
        <div className="card-glow rounded-3xl p-12 text-center relative overflow-hidden">
          <div className="absolute inset-0 opacity-40 pointer-events-none" style={{ background: "transparent" }} />
          <div className="relative">
            ...
            <Link to="/dashboard" className="inline-flex items-center gap-1 mt-6 px-6 py-3 rounded-md bg-gradient-brand text-primary-foreground shadow-sm text-sm font-medium">
